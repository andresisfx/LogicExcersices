...
// *Ejercicio 2: Contar la frecuencia de valores
...
function contarFrecuencia(objeto) {
  
}

console.log(contarFrecuencia(frutas)); // Debería imprimir { manzana: 3, banana: 2, naranja: 1 }